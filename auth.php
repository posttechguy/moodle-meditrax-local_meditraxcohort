<?php
/**
 * Custom authentication for Water Corporation Education project
 *
 * Authentication class
 *
 * @package    auth_watercorped
 ...
 */
class local_plugin_meditraxcohort extends local_plugin_base {
    ...
    public function __construct() {
        $this->authtype = 'watercorped';
        $this->config = get_config('auth/watercorped');
    }
    /**
    ...
    public function login_form($loginurl) {
        ...
        require_once($CFG->dirroot.'/auth/watercorped/forms.php');

        return new auth_watercorped_login_form($loginurl, null, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    public function process_config($config) {
        ...
        // Save settings.
        set_config('recaptcha', $config->recaptcha, 'auth/watercorped');
        return true;
    }
    ...
    public function signup_form() {
        ...
        return new auth_watercorped_signup_form(null, null, 'post', '', array('autocomplete' => 'on'));
    }
    /**
     * Return a form to capture user details for account creation
     * This is used in /login/signup.php
    ...
    public function updateuser_form() {
        ...
        return new auth_watercorped_updateuser_form(null, null, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    public function classessectionform() {
        ...
        return new auth_watercorped_manage_classes_section(null, null, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    public function classform($url, $id) {
        ...
        return new auth_watercorped_classform($url, $id, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    public function studentlistform($url, $teacherid) {
        ...
        return new auth_watercorped_manage_students_classes_section($url, $teacherid, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    public function upload_import_file($url, $teacherid) {
        ...
        return new auth_watercorped_import_students_section($url, $teacherid, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    public function listofallstudents($teacherid) {
        ...
        require_once($CFG->dirroot.'/auth/watercorped/locallib.php');

        return auth_watercorped_get_student_class_table($teacherid);
    }
    ...
    public function deletefromclasseslist($delclass) {
        global $DB;
/*
            JOIN {auth_watercorped_student} AS aws ON aws.studentuserid = awsc.studentuserid
            JOIN {user} AS u ON u.id = aws.studentuserid
*/
        $sql = '
            SELECT awsc.id, awsc.classid, awc.name AS classname
            FROM {auth_watercorped_teacher} AS awt
            JOIN {auth_watercorped_class} AS awc ON awc.teacheruserid = awt.teacheruserid
            JOIN {auth_watercorped_studclass} AS awsc ON awsc.classid = awc.id
    ...
    public function deletefromclassesform($url, $deleteclasslist, $classinfo) {
        ...
        return new auth_watercorped_delete_student_from_class($url, $params, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    public function add_teacher($teacheruserid) {
        ...
        if (!($DB->insert_record('auth_watercorped_teacher',  $newteacher))) {
            $strcontinue = get_string('db:teacher:insert:success', 'auth_watercorped');
        } else {
            $strcontinue = get_string('db:teacher:insert:error', 'auth_watercorped');
        }
        return $strcontinue;
    }
    /**
    ...
    public function remove_teacher($teacheruserid) {
        ...
        if (!($DB->delete_records('auth_watercorped_teacher', array("teacheruserid" => $teacheruserid)))) {
            return false;
        }
        return true;
    }
    ...
    public function add_student($studentuserid) {
        ...
        if (!($DB->insert_record('auth_watercorped_student',  $newstudent))) {
            return false;
        }
        return true;
    }
    ...
    public function remove_student($studentuserid) {
        ...
        if (!($DB->delete_records('auth_watercorped_student', array("studentuserid" => $studentuserid)))) {
            return false;
        }
        return true;
    }
    ...
    public function add_class($teacheruserid, $name) {
        ...
        if ($classid = $DB->insert_record('auth_watercorped_class',  $addparams)) {
          //  $strcontinue = get_string('db:class:insert:success', 'auth_watercorped');

        } else {
          //  $strcontinue = get_string('db:class:insert:error', 'auth_watercorped');
            $classid = 0;
        }
        return $classid;
    }
    ...
    public function update_class_name($classid, $name) {
        ...
        if ($DB->update_record('auth_watercorped_class', $updateparams)) {
            $strcontinue = get_string('db:class:update:success', 'auth_watercorped');
        } else {
            $strcontinue = get_string('db:class:update:error', 'auth_watercorped');
        }
        return $strcontinue;
    }
    /**
    ...
    public function remove_class($id) {
        ...
        if ($DB->delete_records('auth_watercorped_class', array("id" => $id))) {
            $strcontinue = get_string('db:class:delete:success', 'auth_watercorped');
        } else {
            $strcontinue = get_string('db:class:delete:error', 'auth_watercorped');
        }
        return $strcontinue;
    }
    /**
    ...
    public function remove_teacher_classes($removeclasses, $confirmsecret) {
        ...
        if (!($DB->delete_records('auth_watercorped_class', array("teacheruserid" => $teacheruserid)))) {
            return false;
        }
        return true;
    }
    ...
    public function add_student_class($classid, $studentuserid) {
        ...
        if (!($DB->insert_record('auth_watercorped_studclass',  $studclass))) {
            return false;
        }
        return true;
    }
    ...
    public function remove_student_class($classid, $studentuserid) {
        ...
        if ($DB->delete_records('auth_watercorped_studclass', array("classid" => $classid, "studentuserid" => $studentuserid))) {
            $strcontinue = get_string('db:class:delete:success', 'auth_watercorped');
        } else {
            $strcontinue = get_string('db:class:delete:error', 'auth_watercorped');
        }
